...
export const BIOTECH_PLAYBOOK: SeedPlaybookPosition[] = [
  ...
  { key: 'bio-ruo-warranty',          categorySlug: 'warranties',   positionType: 'standard',   content: `<p>"Research use only" labeling for transferred materials. Express disclaimer of safety, efficacy, and fitness for human/diagnostic use.</p>`,                                  notes: 'Required for academic MTAs.',                                                               riskThreshold: 0.6, contractTypes: ['MTA'], sortOrder: 5 },
