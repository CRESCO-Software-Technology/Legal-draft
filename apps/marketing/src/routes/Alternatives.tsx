...
export default function Alternatives() {
  return (
    <>
      <SEO
        title="CLM Alternatives — Honest comparisons"
        description="Looking for an alternative to Ironclad, Harvey, Spellbook, DocuSign CLM, or Icertis? Honest head-to-head comparisons with Draft Legal, the open-source agent-first CLM."
        path="/alternatives"
        ...
        <div className="container-page">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-600">
              Honest head-to-head comparisons against the major contract management vendors. We
              show you where Draft Legal wins, where it doesn't, and how migrations work.
            </p>
          </div>
        </div>
      </section>
