...
export const ironclad: CompareData = {
  ...
  tldr:
    'CRESCO Legal and Ironclad both cover the full contract lifecycle. The decision usually comes down to deployment posture: CRESCO Legal is AGPL-3.0 licensed and self-hostable so your security team can read every line and your contracts can stay in your VPC. Ironclad is a mature managed product with a long track record. Pick whichever model fits your risk appetite.',
  pickProductIf: [
  ...
  migration:
    'Ironclad exports contract metadata and PDFs in standard formats. CRESCO Legal\'s bulk import maps your records into our universal + type-specific schemas, and our team can help with templates and approval rules. Effort depends on your portfolio size.',
  groups: [
    {
    ...
    },
    {
      ...
      rows: [
        ...
        { label: 'AI assistant for review / drafting', product: 'yes', competitor: 'yes', note: 'Jurist' },
      ],
    },
    {
      ...
      rows: [
        ...
        { label: 'eSignature', product: 'yes', competitor: 'partial', note: 'Ironclad integrates external e-sign vendors' },
    ...
    },
    {
      ...
      rows: [
        { label: 'Pricing published on website', product: 'yes', competitor: 'no' },
      ],
    },
  ],
}
